        ...
        <div class="container-fluid">
            <div class="row d-flex align-items-center justify-content-center" style="height: calc(100% - 168px)">
                ...
                <form class="form border rounded-3 p-5 m-2 shadow" style="width: 500px;" method="POST" action="/login">
                    ...
                    <legend class="text-center pb-4">Login</legend>
                    ...
                    <div class="pb-4">
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" placeholder="Email" name="email" aria-label="Email"
                                ...
                                @class([
                                    'is-valid' => $validations['success'] && isset($validations['email']),
                                    'is-invalid' => $validations['invalid'] && isset($validations['email']),
                                    'form-control',
                                ])>
                        </div>
                    ...
                    <div class="pb-4">
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="password" placeholder="Password" name="password"
                                aria-label="Password" aria-describedby="addon-wrapping" @class([
                                    'is-valid' => $validations['success'] && isset($validations['password']),
                                    'is-invalid' => $validations['invalid'] && isset($validations['password']),
                                    'form-control',
                                ])>
                        </div>
